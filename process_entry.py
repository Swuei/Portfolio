    ...
    try:
        ...
        <div class="download-item">
            ...
            <div class="download-links">
                <a class="download-btn" data-download="true" href="{payload["mediafireLink"]}" onclick="trackDownload(event, '{payload["counterName"]}')" target="_blank">
                    <i class="fas fa-file-archive"></i> Download ZIP
                </a>
                <a class="download-btn" href="{payload["sketchfabLink"]}" target="_blank">
